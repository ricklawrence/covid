...
%=== change location PW to RP (PW first appeared 2/4/2022)
index0         = find(strcmp(names0, 'PW'));
names0(index0) = {'RP'};
...
data1 = reshape(dataTable.Additional_Doses_Vax_Pct(index),               numDates, numNames);  vaxData(:,i1,27) = data1(:,i2);
...
state1.vaxLabels  = {'Doses Delivered'; ...
                     ...
                     'Percent of Total Population with Additional Dose'; ...
                    };
